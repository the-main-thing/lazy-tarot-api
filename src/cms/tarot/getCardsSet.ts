import { translateCard, type TranslatedCard } from './translateCard'
...
export const queryContent = async (context: Params[1]) => {
  try {
    const data =
      await context.sanity.client.fetch<Array<CardContentQueryObject> | null>(
        '*[_type=="tarotCard"]',
      )
